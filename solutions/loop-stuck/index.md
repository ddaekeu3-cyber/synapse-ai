...
{%- assign cat_solutions = site.solutions | where: "category", "loop-stuck" | sort: "title" -%}
...
The **[Loop & Stuck Error Guide](/synapse-ai/guide/loop-stuck-errors)** covers root causes, prevention patterns, and checklists for this category of errors.
