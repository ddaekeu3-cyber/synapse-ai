...
category: telegram
description: "Long Telegram conversations split into 2 competing sessions. Previous session responds first, causing interleaved conflicting responses. Users see the bot answer with wrong context or send duplicate replies."중복/충돌 응답 발생 - 사용자 입장에서 봇이 엉뚱한 컨텍스트로 답변하거나 두 번"
---
