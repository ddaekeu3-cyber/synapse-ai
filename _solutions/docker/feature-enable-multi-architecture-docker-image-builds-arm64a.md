...
description: "Build and publish official Docker images for linux/arm64 and linux/arm/v7 architectures alongside the existing linux/amd64 images to support heterogeneous"
---

# [Feature]: Enable Multi-Architecture Docker Image Builds (ARM64/ARMv7)

## 증상
Build and publish official Docker images for linux/arm64 and linux/arm/v7 architectures alongside the existing linux/amd64 images to support heterogeneous computing environments.
