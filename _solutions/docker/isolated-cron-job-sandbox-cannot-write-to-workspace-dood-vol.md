...
description: "In isolated cron job sessions (), the sandbox container's directory is read-only from the agent's perspective — any attempt to write a file via the tool"
---
