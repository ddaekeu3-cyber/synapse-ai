...
description: "When files are uploaded via Slack, they are correctly staged to in the workspace. The sandbox container can see and read the files via shell (, ), but the"
---
