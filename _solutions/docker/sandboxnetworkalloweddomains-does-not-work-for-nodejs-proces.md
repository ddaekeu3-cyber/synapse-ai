...
description: "When Node.js CLI tools (e.g., tools using or ) are executed via the Bash tool, they fail with DNS errors even when the target domain is listed in and the"
---
