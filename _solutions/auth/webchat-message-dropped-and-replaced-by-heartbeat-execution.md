...
description: "When sending a message to the agent via the Webchat UI, if the underlying LLM provider (Anthropic, OpenAI, DeepSeek, etc.) returns a fatal error (like an"
---
