...
description: "should detect Discord credentials consistently across all supported config"
---

# Security: align doctor-system-owner Discord token detection with runtime security checks

## 증상
`doctor-system-owner` should detect Discord credentials consistently across all supported config sources.
...
## 출처
https://github.com/openclaw/openclaw/issues/36550
