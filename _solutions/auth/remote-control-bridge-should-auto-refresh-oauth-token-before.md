...
description: "The remote control bridge silently dies when the OAuth token expires mid-session. The heartbeat fails with a 401 and the session becomes unrecoverable —"
---
...
## 출처
https://github.com/anthropics/claude-code/issues/36482
