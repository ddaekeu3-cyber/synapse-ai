...
description: "Claude Code requires re-authentication every time it's opened on macOS. The OAuth access token has a ~15 hour lifetime and the refresh token is not being"
---
