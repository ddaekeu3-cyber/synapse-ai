...
description: "Two related issues cause OpenAI Codex OAuth to break on gateway"
---

# OAuth refresh tokens not persisted on plugin-path refresh; per-agent auth stores not synced after login

## 증상
Two related issues cause OpenAI Codex OAuth to break on gateway restart:
...
## 출처
https://github.com/openclaw/openclaw/issues/53082
