...
description: "Not able to login via Gemini CLI OAuth as it returned the following"
---

# google-gemini-cli OAuth Error

## 증상
Not able to login via Gemini CLI OAuth as it returned the following error
...
## 출처
https://github.com/openclaw/openclaw/issues/29539
