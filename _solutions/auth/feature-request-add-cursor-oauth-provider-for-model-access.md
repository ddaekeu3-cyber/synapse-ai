...
description: "Add Cursor as a model provider using OAuth, similar to how Codex (openai-codex)"
---

# Feature Request: Add Cursor OAuth provider for model access

## 증상
Add **Cursor** as a model provider using OAuth, similar to how Codex (openai-codex) works.
...
## 출처
https://github.com/openclaw/openclaw/issues/28327
