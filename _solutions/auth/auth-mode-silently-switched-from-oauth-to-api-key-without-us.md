...
description: "The gateway's auth mode for silently switched from OAuth (ChatGPT Plus subscription) to API key mode without any user action. This caused API quota to be"
---
...
## 출처
https://github.com/openclaw/openclaw/issues/30248
