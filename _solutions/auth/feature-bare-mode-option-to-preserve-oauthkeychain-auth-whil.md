...
description: "mode strips all auto-discovery, including OAuth and keychain authentication. This makes it unusable for tools that need clean, context-free API calls but"
---
