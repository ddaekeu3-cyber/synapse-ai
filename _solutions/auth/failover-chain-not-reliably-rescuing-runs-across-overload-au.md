...
description: "Fallback is configured but not consistently rescuing runs when the primary provider"
---

# Failover chain not reliably rescuing runs across overload + auth-expiry errors

## 증상
Fallback is configured but not consistently rescuing runs when the primary provider fails.
...
## 출처
https://github.com/openclaw/openclaw/issues/31806
