...
category: config
source: https://github.com/openclaw/openclaw/issues/37022
---

# [Feature]: Add recursion_limit to prevent infinite agent loops

## 증상
Add a configurable `recursion_limit` (or `max_steps`) parameter to limit the number of reasoning / tool execution cycles in a single agent run.
