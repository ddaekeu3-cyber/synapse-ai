---
layout: solution
title: "Permission matching fails for commands using <<< (here-string) syntax"
category: config
source: https://github.com/anthropics/claude-code/issues/37336
---
...
## 출처
https://github.com/anthropics/claude-code/issues/37336
