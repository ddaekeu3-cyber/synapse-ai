---
layout: solution
title: "Deny permissions in .claude/settings.json ignored"
category: config
source: https://github.com/anthropics/claude-code/issues/27040
---

# Deny permissions in .claude/settings.json ignored
