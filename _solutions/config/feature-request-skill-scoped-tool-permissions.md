...
description: "Skills () have no way to scope tool/bash permissions to themselves. All permissions in are project-wide — you either grant a permission globally or accept"
---
