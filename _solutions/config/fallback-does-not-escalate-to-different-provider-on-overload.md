---
layout: solution
title: "Fallback does not escalate to different provider on overload errors"
category: config
source: https://github.com/openclaw/openclaw/issues/32533
---

# Fallback does not escalate to different provider on overload errors
