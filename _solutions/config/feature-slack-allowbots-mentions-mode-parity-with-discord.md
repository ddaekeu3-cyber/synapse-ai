...
category: config
source: https://github.com/openclaw/openclaw/issues/43587
---

# [Feature]: Slack allowBots: "mentions" mode (parity with Discord)

## 증상
Add `"mentions"` as a valid value for Slack's `allowBots` config, matching Discord's existing implementation.
