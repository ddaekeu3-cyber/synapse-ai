---
layout: solution
title: "[FEATURE] Improve 'defaultMode': 'bypassPermissions' in `settings.json` so it matches `claude --dangerously-skip-permissions`"
category: config
source: https://github.com/anthropics/claude-code/issues/37774
---
...
## 출처
https://github.com/anthropics/claude-code/issues/37774
