---
layout: solution
title: "${XDG_CONFIG_HOME} is not process when installing a skill"
category: config
source: https://github.com/openclaw/openclaw/issues/53628
---

# ${XDG_CONFIG_HOME} is not process when installing a skill
