---
layout: solution
title: "permissions: Bash(rm -r:*) does not match rm -rf"
category: config
source: https://github.com/anthropics/claude-code/issues/28811
---
...
## 출처
https://github.com/anthropics/claude-code/issues/28811
