...
description: "After upgrading from v2026.2.19-2 to v2026.2.21-2, the Google Chat channel immediately crashes on startup and enters a restart loop (up to 10/10 retries)."
---
