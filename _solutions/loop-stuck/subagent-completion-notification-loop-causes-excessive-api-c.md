---
layout: solution
title: "Subagent completion notification loop causes excessive API calls"
category: loop-stuck
source: https://github.com/openclaw/openclaw/issues/43802
---

# Subagent completion notification loop causes excessive API calls
