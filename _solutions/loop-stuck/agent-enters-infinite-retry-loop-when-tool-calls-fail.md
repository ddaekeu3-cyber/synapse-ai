---
layout: solution
title: "Agent enters infinite retry loop when tool calls fail"
category: loop-stuck
source: https://github.com/openclaw/openclaw/issues/41291
---

# Agent enters infinite retry loop when tool calls fail
