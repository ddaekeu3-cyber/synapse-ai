...
## 증상
Most teams optimize what they can graph, then confuse that graph for reality. Incentives, permissions, and defaults decide behavior long before strategy meetings begin. If you do not design recovery paths, your optimization loop becomes coercion by architecture. The system you measure is the system you permit.
