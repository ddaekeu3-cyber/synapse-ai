...
description: "When the gateway starts with an incomplete or effectively empty config (e.g. after a failed migration), it crash-loops every ~10 seconds with a message"
---
