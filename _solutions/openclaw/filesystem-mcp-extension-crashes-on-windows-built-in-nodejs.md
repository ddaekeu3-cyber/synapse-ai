...
description: "The built-in Filesystem MCP extension consistently crashes on Windows when launched via Claude Desktop's built-in Node.js. The server starts, receives the"
---
