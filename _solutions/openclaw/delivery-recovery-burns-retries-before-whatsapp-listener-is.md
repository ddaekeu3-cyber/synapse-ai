...
## 증상
After gateway restart, delivery-recovery runs immediately and retries queued WhatsApp outbound deliveries before the WhatsApp Web listener is ready. This produces errors like:
