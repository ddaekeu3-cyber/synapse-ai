...
description: "When the Feishu session context grows large (77k+ tokens, 181KB session file), the AI model (Kimi-K2.5 via Tencent Coding Plan provider) returns a generic"
---
