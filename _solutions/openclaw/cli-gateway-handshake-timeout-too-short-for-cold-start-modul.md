...
description: "CLI commands that connect to the gateway (e.g. ) fail with on systems where Node.js ESM module compilation takes longer than the gateway's 3-second"
---
