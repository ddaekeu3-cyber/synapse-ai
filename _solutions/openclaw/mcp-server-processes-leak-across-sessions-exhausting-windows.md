...
description: "MCP servers spawned via / (and their child / processes) are not properly terminated when Claude Code sessions end or reconnect. Over multiple sessions,"
---
