...
category: openclaw
source: https://github.com/openclaw/openclaw/issues/50798
---

# [Feature]: Visible agent-to-agent messaging for ACP thread-bound sessions (proxy-only delivery without main session creation)
