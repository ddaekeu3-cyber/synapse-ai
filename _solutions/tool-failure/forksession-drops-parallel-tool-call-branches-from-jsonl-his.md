...
description: "When using with via the Claude Agent SDK, the CLI's fork logic drops parallel tool call branches from the previous session's JSONL history. The fork walks"
---
