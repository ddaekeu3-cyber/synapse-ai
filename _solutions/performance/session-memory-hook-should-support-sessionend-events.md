---
layout: solution
title: "session-memory hook should support session:end events"
category: performance
source: https://github.com/openclaw/openclaw/issues/31266
---

# session-memory hook should support session:end events
