...
description: "When using inside an already-running Claude Code session to switch to a different conversation, the file is not updated with the new session ID. This"
---
