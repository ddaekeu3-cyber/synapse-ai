---
layout: solution
title: "Claude runs explicitly forbidden destructive git commands, ignores own memory rules, destroys user work twice in same session"
category: general
source: https://github.com/anthropics/claude-code/issues/37888
---
