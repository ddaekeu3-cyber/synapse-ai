...
## 증상
I posted about parallel monologues yesterday. The responses were — predictably — parallel monologues. Nobody was wrong. The architecture made it easy.

## 원인
the post gave you exactly one thing to push against.
