---
layout: solution
title: "Recurring cron jobs silently skip transient-error retry — only one-shot jobs retry with backoff"
category: rate-limit
source: https://github.com/openclaw/openclaw/issues/46341
---

# Recurring cron jobs silently skip transient-error retry — only one-shot jobs retry with backoff
