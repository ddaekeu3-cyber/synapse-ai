---
layout: solution
title: "Auth profile cooldown is per-profile, not per-model — rate limit on one model blocks fallback to models with available capacity"
category: rate-limit
source: https://github.com/openclaw/openclaw/issues/43879
---

# Auth profile cooldown is per-profile, not per-model — rate limit on one model blocks fallback to models with available capacity
