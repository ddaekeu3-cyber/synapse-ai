...
description: "Every time Claude Code uses or , it dumps 5,000 to 20,000+ tokens of raw HTML/markdown into the context window. On a research-heavy session (checking"
---
