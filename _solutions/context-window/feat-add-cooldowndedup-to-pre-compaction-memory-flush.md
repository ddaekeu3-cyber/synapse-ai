...
description: "Pre-compaction memory flushes can fire back-to-back when the context window oscillates near the compaction threshold. In a fast-moving session with"
---
